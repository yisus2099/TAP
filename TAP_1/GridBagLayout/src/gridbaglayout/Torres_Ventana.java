...
public class Torres_Ventana extends JFrame {

    public Torres_Ventana() {
           super ("Ejemplo1");
         ...
         constraints.gridheight = 2; // El area de texto debe estirarse en ambos sentidos
         ...
         constraints.weighty = 1.0;  // El botón 1 debe ocupar la posición NORTH de su celda
         constraints.anchor = GridBagConstraints.NORTH; // El botón 1 no debe estirarse. Habíamos cambiado este valor en el area de texto, asi que lo restauramos.
    ...
    public static void main(String[] args) {
        new Torres_Ventana().setVisible(true);
    }
}
